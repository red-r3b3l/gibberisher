...
## MVC architecture
## GUI
## fix / extend num of chars appended
...
## decompose classes into MVCV files
...
class App:
    def __init__(self, root):
        ...
        #WORKING, but commenting to test centering technique w/ canvas
        #bgimg_label = tk.Label(root,image=bg_img)
        #bgimg_label["anchor"] = "nw"
        #bgimg_label.place(x=0,y=0,relheight=1,relwidth=1)
    ...
    # Didn't break code, but didn't update the label, just redrew the window I guess
    #def updateWindow():
    #    root.update()
